...
public class SimilarProductsSpecification : BaseSpecification<Product, Guid>
{
    public SimilarProductsSpecification(Product product, PaginationParams paginationParams)
        : base(x =>
            x.Id != product.Id &&
            ...
            x.Status == ProductStatus.Published)
    {
        ...
        ApplyPaging(paginationParams.PageSize, paginationParams.PageNumber);
        AsNoTracking();
    }
}