    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GuestToken = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferencedId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ReferencedType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InventoryHistories_ProductVariants_ProductVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductImage_IsMain_Valid", "IsMain IN (0, 1)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewHelpfulVotes_ProductReviews_ProductReviewId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemOptions_ProductOptions_ProductOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemOptions_ProductOptionId",
                table: "CartItemOptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryHistories_ProductVariantId",
                table: "InventoryHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewHelpfulVotes_ProductReviewId",
