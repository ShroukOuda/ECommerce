...
public class AddProductDtoValidatorTests
{
    ...
    {
        var dto = new AddProductDTO { Name = "Laptop", Price = 999m, StockQuantity = 10, SKU = "LAP-001", CategoryId = 1 };
    ...
    {
        var dto = new AddProductDTO { Name = "", Price = 999m, SKU = "LAP-001", CategoryId = 1 };
        var result = await _validator.ValidateAsync(dto);
    ...
    {
        var dto = new AddProductDTO { Name = "Laptop", Price = 0, SKU = "LAP-001", CategoryId = 1 };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    ...
    {
        var dto = new AddProductDTO { Name = "Laptop", Price = 999m, StockQuantity = -1, SKU = "LAP-001", CategoryId = 1 };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    }
    ...
    {
        var dto = new AddProductDTO { Name = "Laptop", Price = 999m, SKU = "", CategoryId = 1 };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    ...
    {
        var dto = new AddProductDTO { Name = "Laptop", Price = 999m, SKU = "LAP-001", CategoryId = 0 };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
