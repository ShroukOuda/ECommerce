...
public class CreateShippingDtoValidatorTests
{
    ...
    {
        var dto = new CreateShippingDTO { OrderId = TestGuid.FromInt(1), AddressId = TestGuid.FromInt(1), Cost = 9.99m, Method = "Express" };
    ...
    {
        var dto = new CreateShippingDTO { OrderId = Guid.Empty, AddressId = TestGuid.FromInt(1), Cost = 9.99m, Method = "Express" };
        var result = await _validator.ValidateAsync(dto);
    ...
    {
        var dto = new CreateShippingDTO { OrderId = TestGuid.FromInt(1), AddressId = Guid.Empty, Cost = 9.99m, Method = "Express" };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    ...
    {
        var dto = new CreateShippingDTO { OrderId = TestGuid.FromInt(1), AddressId = TestGuid.FromInt(1), Cost = -1, Method = "Express" };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    ...
    {
        var dto = new CreateShippingDTO { OrderId = TestGuid.FromInt(1), AddressId = TestGuid.FromInt(1), Cost = 0, Method = "Express" };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeTrue();
    }
    ...
    {
        var dto = new CreateShippingDTO { OrderId = TestGuid.FromInt(1), AddressId = TestGuid.FromInt(1), Cost = 9.99m, Method = method! };
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
